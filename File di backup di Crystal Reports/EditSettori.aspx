...
<%@ Page language="c#" Codebehind="EditSettori.aspx.cs" AutoEventWireup="false" Inherits="TheSite.Gestione.EditSettori" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>EditSettori</title>
											...
											<TABLE id="tblSearch75" cellSpacing="1" cellPadding="2" border="0">
												<TR>
													...
													<TD style="HEIGHT: 24px">
														<cc1:S_TextBox id="txtsCodice" tabIndex="1" runat="server" Width="346px" DBIndex="0" DBParameterName="p_CodiceSettore"
															DBSize="15" DBDirection="Input" MaxLength="15"></cc1:S_TextBox></TD>
												</TR>
												<TR>
													...
													<TD style="HEIGHT: 23px">
														<cc1:S_TextBox id="txtsDescrizione" tabIndex="2" runat="server" Width="90%" DBIndex="1" DBParameterName="p_Descrizione"
															DBSize="255" DBDirection="Input" MaxLength="255" DBDataType="VarChar"></cc1:S_TextBox></TD>
												</TR>
												<TR>
													<TD style="HEIGHT: 23px" align="left">Note:</TD>
													<TD style="HEIGHT: 23px">
														<cc1:S_TextBox id="txtsNote" tabIndex="2" runat="server" Width="90%" DBIndex="2" DBParameterName="p_Note"
															DBSize="3000" DBDirection="Input" MaxLength="3000" DBDataType="VarChar" TextMode="MultiLine"></cc1:S_TextBox></TD>
												</TR>
											</TABLE>
										</asp:panel></TD>
								</TR>
