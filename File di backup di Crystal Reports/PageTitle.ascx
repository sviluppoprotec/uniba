<%@ Control Language="c#" AutoEventWireup="false" Codebehind="PageTitle.ascx.cs" Inherits="TheSite.WebControls.PageTitle" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
