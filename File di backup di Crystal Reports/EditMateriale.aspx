	...
	<body onbeforeunload="parent.left.valorizza()" MS_POSITIONING="GridLayout">
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="TableMain" style="Z-INDEX: 101; LEFT: 0px; WIDTH: 100%; POSITION: absolute; TOP: 0px; HEIGHT: 100%"
								...
								<TR>
									...
									<TD vAlign="top" align="left"><asp:panel id="PanelEdit" runat="server">
											<TABLE id="tblSearch75" cellSpacing="1" cellPadding="2" border="0">
												<TBODY>
													<TR>
														<TD style="WIDTH: 178px; HEIGHT: 24px" align="left">Codice Materiale&nbsp;
														...
														<TD style="HEIGHT: 24px">
															<cc1:S_TextBox id="txtCodMateriale" tabIndex="0" runat="server" DBIndex="0" DBParameterName="p_codice"
									...
									<TD style="HEIGHT: 23px">
										<cc1:S_TextBox id="txtDescMateriale" tabIndex="1" runat="server" Width="90%" DBIndex="1" DBParameterName="p_descrizione"
											DBSize="50" DBDirection="Input" DBDataType="VarChar"></cc1:S_TextBox></TD>
								</TR>
								<TR>
									<TD style="WIDTH: 178px; HEIGHT: 23px" align="left">Prezzo</TD>
									<TD style="HEIGHT: 23px">
										<asp:TextBox id="txtPrezzoIntero" style="TEXT-ALIGN: right" runat="server" Width="10%" MaxLength="8">0</asp:TextBox>,
										<asp:TextBox id="txtPrezzoDecimale" style="TEXT-ALIGN: left" runat="server" Width="5%" MaxLength="2">00</asp:TextBox>
				...
				<TR>
					<TD style="WIDTH: 178px; HEIGHT: 17px" align="left">Unita Misura
						<asp:RequiredFieldValidator id="rfvUnita" runat="server" ControlToValidate="cmbUnita" ErrorMessage="Selezionare l'Unità di Misura!"
							InitialValue="0">*</asp:RequiredFieldValidator></TD>
					<TD style="HEIGHT: 17px">
						<cc1:S_ComboBox id="cmbUnita" tabIndex="2" runat="server" Width="248px" DBIndex="5" DBParameterName="p_unita"
