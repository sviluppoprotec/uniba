...
<%@ Page language="c#" Codebehind="EditCategorie.aspx.cs" AutoEventWireup="false" Inherits="TheSite.Gestione.EditCategorie" %>
...
<cc1:S_TextBox id=txtsCodice tabIndex=1 runat="server" Width="346px" MaxLength="15" DBDirection="Input" DBSize="15" DBParameterName="p_CodiceCategoria" DBIndex="0"></cc1:S_TextBox></TD></TR>
              <TR>
...
<cc1:S_TextBox id=txtsDescrizione tabIndex=2 runat="server" Width="90%" MaxLength="255" DBDirection="Input" DBSize="255" DBParameterName="p_Descrizione" DBIndex="1" DBDataType="VarChar"></cc1:S_TextBox></TD></TR>
              <TR>
                <TD style="HEIGHT: 23px" align=left>Note:</TD>
                <TD style="HEIGHT: 23px">
<cc1:S_TextBox id=txtsNote tabIndex=2 runat="server" Width="90%" MaxLength="3000" DBDirection="Input" DBSize="3000" DBParameterName="p_Note" DBIndex="2" DBDataType="VarChar" TextMode="MultiLine"></cc1:S_TextBox></TD></TR></TABLE>
										</asp:panel></TD>
								</TR>
								<tr>
