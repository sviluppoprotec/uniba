<%@ Page language="c#" Codebehind="Categorie.aspx.cs" AutoEventWireup="false" Inherits="TheSite.Gestione.Categorie" %>
		...
		<form id="Form1" method="post" runat="server">
            ...
            <TABLE id=tblSearch100 cellSpacing=0 cellPadding=2 border=0>
              <TR>
                ...
                <TD width="30%">
<cc1:s_textbox id=txtsCodice runat="server" MaxLength="15" DBSize="15" width="208px" DBDirection="Input" DBParameterName="p_CodiceCategoria"></cc1:s_textbox></TD>
								...
								<TD style="HEIGHT: 72%" vAlign="top" align="center"><uc1:gridtitle id="GridTitle1" runat="server"></uc1:gridtitle><asp:datagrid id="DataGridRicerca" runat="server" CssClass="DataGrid" BorderColor="Gray" BorderWidth="1px"
										...
										<Columns>
											...
											<asp:TemplateColumn>
												...
												<ItemTemplate>
													<asp:ImageButton id="Imagebutton3" Runat=server CommandName="Dettaglio" ImageUrl="~/images/Search16x16_bianca.jpg" CommandArgument='<%# "EditCategorie.aspx?ItemID=" + DataBinder.Eval(Container.DataItem,"ID") + "&FunId=" + FunId + "&TipoOper=read"%>'>
													</asp:ImageButton>
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:TemplateColumn>
												...
												<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
												<ItemTemplate>
													<asp:ImageButton id="Imagebutton2" Runat=server CommandName="Dettaglio" ImageUrl="~/images/edit.gif" CommandArgument='<%# "EditCategorie.aspx?ItemID=" + DataBinder.Eval(Container.DataItem,"ID") + "&FunId=" + FunId + "&TipoOper=write"%>'>
													</asp:ImageButton>
												</ItemTemplate>
											</asp:TemplateColumn>
											<asp:BoundColumn DataField="codice_categoria" HeaderText="Codice Categoria">
												<HeaderStyle Width="25%"></HeaderStyle>
											</asp:BoundColumn>
											<asp:BoundColumn DataField="descrizione" HeaderText="Descrizione Categoria">
