		...
		<form id="Form1" method="post" runat="server">
            ...
            <TABLE id=tblSearch100 cellSpacing=0 cellPadding=2 border=0>
              <TR>
                ...
                <TD width="30%">
<cc1:s_textbox id=txtsCodice runat="server" MaxLength="5" DBSize="5" width="208px" DBDirection="Input" DBParameterName="p_codice" DBIndex="2"></cc1:s_textbox></TD>
                <TD align=left width="20%">Descrizione</TD>
                <TD width="30%">
<cc1:s_textbox id=txtsDescrizione tabIndex=2 runat="server" MaxLength="255" DBSize="255" DBDirection="Input" DBParameterName="p_descrizione" DBIndex="0" DBDataType="VarChar" Width="208px"></cc1:s_textbox></TD></TR>
              <TR>
                <TD align=left width="20%">Settore</TD>
                <TD width="30%">
<cc1:S_ComboBox id=cmbsSettore runat="server" DBSize="3" DBDirection="Input" DBParameterName="p_settore" DBIndex="2" DBDataType="Integer"></cc1:S_ComboBox></TD>
                <TD align=left width="20%">Note:</TD>
                <TD width="30%">
<cc1:s_textbox id=txtsNote runat="server" MaxLength="500" DBSize="500" width="208px" DBDirection="Input" DBParameterName="p_note" DBIndex="1"></cc1:s_textbox></TD></TR>
              <TR>
