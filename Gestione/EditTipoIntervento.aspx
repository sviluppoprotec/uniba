<%@ Page language="c#" Codebehind="EditTipoIntervento.aspx.cs" AutoEventWireup="false" Inherits="TheSite.Gestione.EditTipoIntervento" %>
            ...
            <TABLE id=tblSearch75 cellSpacing=1 cellPadding=2 border=0>
              <TR>
                <TD style="WIDTH: 178px; HEIGHT: 24px" align=left>Descrizione 
                  Breve&nbsp; 
<asp:RequiredFieldValidator id=rfvEqstd runat="server" ControlToValidate="txtsdescrizionebreve" ErrorMessage="La Descrizione Breve è obbligatoria">*</asp:RequiredFieldValidator></TD>
                <TD style="HEIGHT: 24px">
<cc1:S_TextBox id=txtsdescrizionebreve tabIndex=1 runat="server" DBDirection="Input" DBSize="16" DBParameterName="p_descrizione_breve" DBIndex="0" MaxLength="25"></cc1:S_TextBox></TD></TR>
              <TR>
                <TD style="WIDTH: 178px; HEIGHT: 23px" 
                align=left>Descrizione</TD>
                <TD style="HEIGHT: 23px">
<cc1:S_TextBox id=txtsdescrizione tabIndex=2 runat="server" Width="90%" DBDirection="Input" DBSize="255" DBParameterName="p_descrizione" DBIndex="1" MaxLength="255" DBDataType="VarChar"></cc1:S_TextBox></TD></TR></TABLE>
										</asp:panel></TD>
								</TR>
								<tr>
