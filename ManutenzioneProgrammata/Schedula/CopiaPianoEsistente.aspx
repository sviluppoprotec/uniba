...
<%@ Page language="c#" Codebehind="CopiaPianoEsistente.aspx.cs" AutoEventWireup="false" Inherits="TheSite.ManutenzioneProgrammata.Schedula.CopiaPianoEsistente" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>CopiaPianoEsistente</title>
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="TableMain" style="Z-INDEX: 101; LEFT: 8px; POSITION: absolute; TOP: 8px" cellSpacing="0"
				...
				<TBODY>
					...
					<TR>
						<TD vAlign="top" align="center">
							<TABLE id="tblForm" cellSpacing="1" cellPadding="1" align="center">
								<TBODY>
									<TR vAlign="top">
										<TD align="center" colSpan="1" rowSpan="1"><COLLAPSE:DATAPANEL id="PanelRicerca" runat="server" TitleStyle-CssClass="TitleSearch" ExpandImageUrl="../Images/down.gif"
												...
												<TABLE id="tblSearch100" cellSpacing="1" cellPadding="2" border="0">
													...
													<asp:Panel id="PagePanel" Runat="server">
														<TR>
															<TD style="WIDTH: 15%"><SPAN>Ricerca il piano dall'anno: </SPAN>
															</TD>
															<TD style="HEIGHT: 28px">
																<cc1:S_ComboBox id="cmbsAnnoDa" runat="server" AutoPostBack="false" Width="230px" DBDataType="Integer"></cc1:S_ComboBox></TD>
															<TD style="WIDTH: 15%"><SPAN>all'anno: </SPAN>
															</TD>
															<TD style="HEIGHT: 28px">
																<cc1:S_ComboBox id="cmbsAnnoA" runat="server" AutoPostBack="false" Width="230px" DBDataType="Integer"></cc1:S_ComboBox></TD>
														</TR>
														<TR>
															...
															<TABLE id="Table1" style="HEIGHT: 19px" cellSpacing="0" cellPadding="0" width="100%" border="0">
																<TR>
																	<TD align="left" colSpan="3">
																		...
																		<asp:Button id="cmdReset" CssClass="btn" Runat="server" Text="Reset"></asp:Button>&nbsp;
																		<asp:Label id="lblNessunPiano" runat="server" ForeColor="Red" Visible="False" Font-Size="Smaller"
																			Font-Bold="True">Attenzione: Impossibile utilizzare questa funzionalità in quanto non è presente alcun piano precedente</asp:Label></TD>
					...
					<tr>
						<TD vAlign="top" align="center"><uc1:gridtitle id="GridTitle1" runat="server"></uc1:gridtitle><asp:datagrid id="DataGridRicerca" runat="server" CssClass="DataGrid" AllowPaging="True" GridLines="Vertical"
								...
								<Columns>
									...
									<asp:BoundColumn DataField="ANNO" HeaderText="ANNO" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>
			...
			<asp:panel id="panelCopia" Runat="server" Visible="False">
				<TABLE id="tblSearch100" cellSpacing="1" cellPadding="2" border="0">
					<TR>
						<TD style="WIDTH: 15%; HEIGHT: 6px"><SPAN>Copia il piano dell'anno: </SPAN>
						</TD>
						<TD style="HEIGHT: 6px">
							<cc1:S_ComboBox id="cmbsAnnoCopiato" runat="server" AutoPostBack="false" Width="230px" DBDataType="Integer"></cc1:S_ComboBox></TD>
						<TD style="WIDTH: 15%; HEIGHT: 6px"><SPAN>per l'anno: </SPAN>
						</TD>
						<TD style="HEIGHT: 6px">
							<cc1:S_ComboBox id="cmbsAnnoRiferimento" runat="server" AutoPostBack="false" Width="230px" DBDataType="Integer"></cc1:S_ComboBox></TD>
					</TR>
					<TR>
						<TD colSpan="4">
					&nbsp;
					<TR>
						<TD align="left" colSpan="3">
							<CC1:S_BUTTON id="btnsCopiaPiano" tabIndex="2" runat="server" CssClass="btn" Text="Copia Piano"></CC1:S_BUTTON></TD>
