...
//		}
		...
		public void SendMail(TipoMail tipomail)
		{
			...
			writer.WriteElementString("codedi",this.codedi);
			writer.WriteElementString("responsabile",this.responsabile);
			writer.WriteElementString("richiedente",this.Richiedente);
			...
			//			msg.Fields("http://schemas.microsoft.com/cdo/configuration/sendpassword") = "password";
			//SmtpMail.SmtpServer="www.prm-ater-gescal.it.compsys"; 
			if(System.Configuration.ConfigurationSettings.AppSettings["usersmtp"].ToString()!="")
			{
				msg.Fields["http://schemas.microsoft.com/cdo/configuration/smtpauthenticate"] = 1;
				msg.Fields["http://schemas.microsoft.com/cdo/configuration/sendusername"] = System.Configuration.ConfigurationSettings.AppSettings["usersmtp"].ToString(); 
				msg.Fields["http://schemas.microsoft.com/cdo/configuration/sendpassword"] = System.Configuration.ConfigurationSettings.AppSettings["pwdsmtp"].ToString();
			}
			SmtpMail.SmtpServer = System.Configuration.ConfigurationSettings.AppSettings["SmtpServer2"].ToString();
			//
