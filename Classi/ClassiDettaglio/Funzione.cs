...
{
	/// <summary>
	/// Descrizione di riepilogo per Funzione.
	/// </summary>
	public class Funzione : AbstractBase
	{
		...
		public Funzione(int Id) : this(Id, string.Empty) {}
		...
		public override DataSet GetData()
		{
			...
			string s_StrSql = "PACK_FUNZIONI.SP_GETALLFUNZIONI";	
		...
		public override DataSet GetData(S_ControlsCollection CollezioneControlli)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_FUNZIONI.SP_GETFUNZIONI";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		...
		public override DataSet GetSingleData(int itemId)
		{
			...
			s_Id.ParameterName = "p_Funzione_Id";
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_FUNZIONI.SP_GETSINGLEFUNZIONE";	
