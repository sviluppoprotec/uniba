					...
					<TD valign="middle">
						<DIV align="center">
							<TABLE style="BORDER-RIGHT: slategray 1px outset; BORDER-TOP: slategray 1px outset; BORDER-LEFT: slategray 1px outset; WIDTH: 430px; BORDER-BOTTOM: slategray 1px outset; HEIGHT: 300px"
								...
								<TR>									
									<TD colspan="2">Inserisci la username e la password relativa al sistema informativo per la gestione dei servizi di: <b><%= System.Configuration.ConfigurationSettings.AppSettings["ApplicationName"]%></b></TD>
								</TR>
								<TR>
